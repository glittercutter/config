...
" Operator
syn match   cCustomOp      "[-+&|<>=!\/~.,;:*%&^?@]" contains=cComment,cCommentStart,cCommentL,cCommentString
hi def link cCustomOp       Operator

" Square bracket
syn match   cCustomSqBracket "[\[\]]"
hi def link cCustomSqBracket Constant

" Parentheses
syn match   cCustomBlock  "[{}()]"
syn match   cCustomCaller "\w\+\(->\|\.\)" contains=cCustomOp

" Highlight Class and Function names
syn match   cCustomParen    "(" contains=cParen,cCppParen
syn match   cCustomFunc     "\w\+\s*(" contains=cCustomParen
syn match   cCustomScope    "::" contains=cCustomOp
